        ...
        <>
            <div className="container">
                <div className={`benefit-block ${props}`}>
                    <div className="list-benefit grid items-start lg:grid-cols-3 grid-cols-2 gap-[30px]">
                        <div className="benefit-item flex flex-col items-center justify-center">
                            ...
                            <div className="caption1 text-black text-center mt-3">We&apos;re here to help you with any questions or concerns you have, 24/7.</div>
                        </div>
                        {/* <div className="benefit-item flex flex-col items-center justify-center">
                        ...
                        <div className="benefit-item flex flex-col items-center justify-center">
                            ...
                            <div className="caption1 text-black text-center mt-3"> We stand behind our products and services and guarantee your satisfaction.</div>
                        </div>
                        <div className="benefit-item flex flex-col items-center justify-center">
                            <i className="icon-delivery-truck lg:text-7xl text-5xl"></i>
                            <div className="heading6 text-center mt-5">Shipping worldwide</div>
                            <div className="caption1 text-black text-center mt-3">We ship our products worldwide, making them accessible to customers everywhere.</div>
                        </div>
                    </div>
                </div>
            </div>
