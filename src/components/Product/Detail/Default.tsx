                    ...
                    <div className="container flex justify-between gap-y-6 flex-wrap">
                        ...
                        <div className="product-infor md:w-1/2 w-full lg:pl-[15px] md:pl-2">
                            <div className="flex justify-between">
                                <div>
                                    <div className="caption2 text-black font-semibold uppercase">{productMain.type}</div>
                            ...
                            <div className="flex items-center mt-3 gap-2">
                                ...
                                <span className='caption1 text-black'>{productMain.rate} reviews</span>
                            </div>
                            <div className="flex items-center gap-3 flex-wrap mt-5 pb-6 border-b border-line">
                                ...
                                <div className='desc text-black mt-3'>{productMain.description}</div>
                            </div>
                            <div className="list-action mt-6">
                                ...
                                <div className="more-infor mt-6">
                                    ...
                                    <div className="flex items-center gap-1 mt-3">
                                        ...
                                        <div className="text-black">{productMain.gtin || '53453412'}</div>
                                    </div>
                                    <div className="flex items-center gap-1 mt-3">
                                        <div className="text-title">Categories:</div>
                                        <div className="text-black">{productMain.category}, {productMain.gender}</div>
                                    </div>
                                    <div className="flex items-center gap-1 mt-3">
                                        <div className="text-title">Tag:</div>
                                        <div className="text-black">{productMain.type}</div>
                                    </div>

                                    {/* Display dimensions if available */}
                                    {productMain.dimensions && (
                                        <div className="dimensions-block mt-5 pt-5 border-t border-line">
                                            <div className="heading6 mb-3">Dimensions</div>
                                            <div className="grid grid-cols-2 gap-3">
                                                {productMain.dimensions.width && (
                                                    <div className="flex items-center gap-1">
                                                        <div className="text-title">Width:</div>
                                                        <div className="text-black">{productMain.dimensions.width} m</div>
                                                    </div>
                                                )}
                                                {productMain.dimensions.height && (
                                                    <div className="flex items-center gap-1">
                                                        <div className="text-title">Height:</div>
                                                        <div className="text-black">{productMain.dimensions.height} m</div>
                                                    </div>
                                                )}
                                                {productMain.dimensions.depth && (
                                                    <div className="flex items-center gap-1">
                                                        <div className="text-title">Depth:</div>
                                                        <div className="text-black">{productMain.dimensions.depth} m</div>
                                                    </div>
                                                )}
                                                {productMain.dimensions.mass && (
                                                    <div className="flex items-center gap-1">
                                                        <div className="text-title">Weight:</div>
                                                        <div className="text-black">{productMain.dimensions.mass} g</div>
                                                    </div>
                                                )}
                                            </div>
                                        </div>
                                    ...
                                    {/* Display origin and shipping information if available */}
                                    {(productMain.origin || (productMain.shippingFromCountries && productMain.shippingFromCountries.length > 0)) && (
                                        <div className="shipping-block mt-5 pt-5 border-t border-line">
                                            <div className="heading6 mb-3">Shipping Information</div>
                                            {productMain.origin && (
                                                <div className="flex items-center gap-1 mt-2">
                                                    <div className="text-title">Origin:</div>
                                                    <div className="text-black">{productMain.origin}</div>
                                                </div>
                                            )}
                                            {productMain.shippingFromCountries && productMain.shippingFromCountries.length > 0 && (
                                                <div className="flex items-start gap-1 mt-2">
                                                    <div className="text-title">Ships from:</div>
                                                    <div className="text-black">{productMain.shippingFromCountries.join(', ')}</div>
                                                </div>
                                            )}
                                            {productMain.delay && (
                                                <div className="flex items-center gap-1 mt-2">
                                                    <div className="text-title">Shipping delay:</div>
                                                    <div className="text-black">{productMain.delay} days</div>
                                                </div>
                                            )}
                                        </div>
                                    )}
